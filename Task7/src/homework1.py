...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, batch_x in enumerate(labeled_loader):
            ...
            entropy_loss = entropy_regularization_loss(model(batch_u)) # add entropy_loss!
            
            L = labeled_loss + unlabeled_loss + lambda_entropy * entropy_loss
            L.backward()
            optimizer.step()
            optimizer.zero_grad()
            ...
            if batch_idx % 100 == 0:
                ...
                print("Epoch: {}, Iter: {}, Entropy Loss: {}".format(epoch, batch_idx, entropy_loss))
